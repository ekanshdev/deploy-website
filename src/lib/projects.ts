...
export const projects: Project[] = [
  {
    ...
    build:
      "A responsive storefront with collection pages, product detail layouts, an About story, and contact. Everything built around the brand's blush and gold palette.",
    metrics: [
